...
Postoji više načina za organizovanje podataka, ali najzastuoljeniji je \textbf{relacioni model}.
...
\begin{itemize}
    \item \textbf{Primarni ključ (Primary Key):} čini svaki red autentičan. Svaka tabela mora imati primarni ključ i on mora biti jedinstven. 
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Jedan-prema-jedan ($1:1$):} Specifična veza gde se zapisi iz dve tabele uparuju po principu ,,jedan na jedan''. Ovakve tabele se često mogu predstaviti kao jedinstvena tabela. Primer:
        \begin{itemize}
        \item Svakom učeniku odgovara tačno jedan par roditelja. Svaki par roditelja u bazi tog konkretnog odeljenja odgovara tačno jednom učeniku.
        \end{itemize}
\end{itemize}
